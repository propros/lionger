...
private:
    ...
    void getdownColChain(SushiSprite *sushi, std::list<SushiSprite *> &chainList);// 斜下
    void getupColChain(SushiSprite *sushi, std::list<SushiSprite *> &chainList);//斜
    void getRowChain(SushiSprite *sushi, std::list<SushiSprite *> &chainList); //纵向
    void removeSushi();
